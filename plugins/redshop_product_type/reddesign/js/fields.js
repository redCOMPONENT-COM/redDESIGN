...
function addNewRow_attribute(tableRef){
	...
	newTD1.innerHTML = '<table class="grey_solid_area"  width="100%" cellpadding="0" border="0" cellspacing="0" id="property_table' + gh + '">' +
							'<tr class="attr_tbody" id="attr_tbody' + gh + p + '">' +
								'<td>' +
									'<table class="attribute_value" width="100%" cellpadding="0" border="0" cellspacing="0" id="attribute_table' + gh + p + '">' +
										'<tr>' +
											'<td class="red_blue_blue td1">' +
												'<img class="arrowimg" onclick="showhidearrow(\'attribute_parameter_tr\', \'' + gh + p + '\'); showhidearrow(\'sub_property\', \'' + gh + p + '\')" id="arrowimg' + gh + p + '" src="../administrator/components/com_redshop/assets/images/arrow.png" alt="img"/>' +
												prop +
											'</td>' +
											'<td class="td2"  align="right">' +
												'<input type="text" class="text_area input_t1" name="attribute[' + gh + '][property][' + total_g + '][name]" >' +
											'</td>' +
											'<td class="td3" align="right">' +
												ord +
												':<input type="text" class="text_area input_t4" name="attribute[' + gh + '][property][' + total_g + '][order]" size="3" value="0" >' +
											'</td>' +
											'<td align="right" class="td4">' +
												adselected +
												':<input type="checkbox" name="attribute[' + gh + '][property][' + total_g + '][default_sel]" \'>' +
												'<input type="hidden" name="attribute[' + gh + '][property][' + total_g + '][default_sel]" id="hdnpropdselected' + gh + p + '">' +
												'<input type="hidden" name="propsub_attdselected[' + gh + '][value][]" id="hdnpropsub_attdselected' + gh + p + '" >' +
											'</td>' +
											'<td class="td5" align="right">' +
												pri +
												'<input type="text" class="text_area input_t3" size="2" name="attribute[' + gh + '][property][' + total_g + '][oprand]" id="oprand' + gh + '0" style="text-align: center;" maxlength="1" value="+" onchange="javascript:oprand_check(this);" >' +
												'&nbsp;<input type="text" class="text_area input_t2" name="attribute[' + gh + '][property][' + total_g + '][price]" id="price" >' +
											'</td>' +
											'<td class="td6">&nbsp;</td>' +
											'<td class="td7">' +
												'<div class="repon">' +
													'<table border="0" width="100%" cellspacing="0" cellpadding="0" class="up_image">' +
														'<tr>' +
															'<td class="td1" style="padding-right: 10px;">&nbsp;</td>' +
															'<td class="td2" align="left">' +
																'<div class="button2-left">' +
																	'<div class="image">' +
																		'<a class="modal" id="modal' + gh + '0" title="Image" href="index.php?tmpl=component&option=com_redshop&view=media&fsec=property&fid='+gh+'0&layout=thumbs" rel="{handler: \'iframe\', size: {x: 900, y: 500}}"></a>' +
																	'</div>' +
																'</div>' +
																'<input type="file" size="20" name="attribute_' + gh + '_property_' + total_g + '_image"  />' +
																'<input type="hidden" class="text_area" size="12" name="attribute[' + gh + '][property][' + total_g + '][imagetmp]"  />' +
																'<input type="hidden"  name="attribute[' + gh + '][property][' + total_g + '][mainImage]" id="propmainImage' + gh +'0" value="">' +
															'</td>' +
															'<td class="td3">&nbsp;</td>' +
															'<td class="td4">' +
																'<img id="propertyImage' + gh + '0" src="" style="display: none;" />' +
															'</td>' +
															'<td class="td5" align="right" style="padding-right: 25px;">' +
																'<span>Published:&nbsp;</span>' +
																'<input type="checkbox" class="text_area" size="55" name="attribute[' + gh + '][property][' + total_g + '][published]" checked="checked"  value="1">' +
																'<span>&nbsp;Extra Field:&nbsp;</span>' +
																'<input type="input" class="text_area" size="8" name="attribute[' + gh + '][property][' + total_g + '][extra_field]" value="">' +
																'<div class="remove_attr">' +
																	'<input value="Delete" onclick="javascript:deleteRow_property(\'property_table' + gh + p + '\',\'property_table' + gh + '\',\'sub_attribute_table' + gh + p + '\',\'' + gh + p + '\')" class="btn_attribute_remove" type="button" />' +
																	'<input type="hidden" name="attribute[' + gh + '][property][' + total_g + '][property_id] value="0" >' +
																'</div>' +
															'</td>' +
														'</tr>' +
													'</table>' +
								...
								'</td>' +
							'</tr>' +
							'<tr class="attribute_parameter_tr" id="attribute_parameter_tr' + gh + p + '" style="display:none">' +
								'<td>' +
									'<table width="100%" border="0" cellpadding="0" cellspacing="0" >' +
										'<tr>' +
											'<td class="red_blue_blue td1">' +
												'<span style="padding-left: 10px;">Attribute parameter</span>' +
											'</td>' +
											'<td class="td2" align="right">' +
												'<input type="text" value="" class="text_area input_t1" name="attribute[' + gh + '][property][' + total_g + '][subproperty][title]">' +
											'</td>' +
											'<td class="td3"></td>' +
											'<td class="td4" align="right">' +
												'Required: <input type="checkbox" onchange="javascript:if(this.checked){document.getElementById(&quot;hdnpropsub_attdselected12&quot;).value=1;}else{document.getElementById(&quot;hdnpropsub_attdselected12&quot;).value=0;}" name="attribute[' + gh + '][property][' + total_g + '][req_sub_att]">' +
												'<input type="hidden" id="hdnpropsub_attdselected12" name="propsub_attdselected[1][value][]">' +
											'</td>' +
											'<td class="td5" align="right">' +
												'Multiselect: <input type="checkbox" onchange="javascript:if(this.checked){document.getElementById(&quot;hdnpropsub_multiselected12&quot;).value=1;}else{document.getElementById(&quot;hdnpropsub_multiselected12&quot;).value=0;}" name="attribute[' + gh + '][property][' + total_g + '][multi_sub_att]">' +
												'<input type="hidden" id="hdnpropsub_multiselected12" name="propsub_multiselected[1][value][]">' +
											'</td>' +
											'<td class="td6" align="right">' +
												'Display Type <select name="attribute[' + gh + '][property][' + total_g + '][setdisplay_type]">' +
								...
								'</td>' +
							'</tr>' +
							'<tr class="sub_property" id="sub_property' + gh + p + '">' +
								'<td style="padding: 0px;">' +
									'<table width="100%" border="0" cellpadding="0" cellspacing="0"  id="sub_property_table' + gh + p + '">' +
										'<tr>' +
											'<td colspan="12" class="td1" style="border-right: 1px solid #CCCCCC;" valign="top">' +
												'<a href="javascript: addsubproperty(\'sub_attribute_table' + gh + '0\',\'' + gh + '\',\'0\')" class="btn_attribute">+ ' +
													new_sub_prop +
												'</a>' +
											'</td>' +
											'<td>' +
												'<table width="100%" border="0" cellpadding="0"  cellspacing="0" id="sub_attribute_table' + gh + '0" class="sub_attribute_table">' +
...
function addproperty(tableRef,rh){
	...
	newTD.innerHTML = '<table id="attribute_table'+h+'" class="attribute_value">' +
						'<tr>' +
							'<td class="red_blue_blue td1">' +
								'<img  class="arrowimg" onclick="showhidearrow(\'attribute_parameter_tr\', \'' + rh + h + '\'); showhidearrow(\'sub_property\', \'' + rh + h + '\')" id="arrowimg' + rh + h + '" src="../administrator/components/com_redshop/assets/images/arrow.png" alt="img"/>' +
								prop +
							'</td>' +
							'<td class="td2" align="right">' +
								'<input type="text" size="22" class="text_area input_t1"  name="attribute[' + rh + '][property][' + h + '][name]" >' +
								'<input type="hidden" name="attribute[' + rh + '][property][' + h + '][property_id]" value="0" >' +
							'</td>' +
							'<td class="td3" align="right">' +
								ord + ': ' +
								'<input type="text" class="text_area input_t4" name="attribute[' + rh + '][property][' + h + '][order]" size="2" value="' + or + '" >' +
							'</td>' +
							'<td class="td4" align="right">' +
								adselected + ': ' +
								'<input type="checkbox" name="attribute[' + rh + '][property][' + h + '][default_sel]" onChange=\'javascript:if(this.checked){document.getElementById("hdnpropdselected' + rh + or + '").value=1;}else{document.getElementById("hdnpropdselected' + rh + or + '").value=0;}\'>' +
								'<input type="hidden" name="attribute[' + rh + '][property][' + h + '][propselected]" id="hdnpropdselected' + rh + or + '" >' +
							'</td>' +
							'<td class="td5" align="right">' +
								pri + ': ' +
								...
								'<input type="text" size="8" class="text_area input_t2" name="attribute[' + rh + '][property][' + h + '][price]"  >' +
							'</td>' +
							'<td class="td6">' +
							'</td>' +
							'<td class="td7">' +
									...
									'<table border="0" width="100%" cellspacing="0" cellpadding="0" class="up_image">' +
										'<tr>' +
											...
											'<td class="td2" align="left">' +
												'<div class="button2-left">' +
													'<div class="image">' +
														'<a class="modal" id="modal' + rh + or + '" title="Image" href="index.php?tmpl=component&option=com_redshop&view=media&fsec=property&fid=' + rh + or + '&layout=thumbs" rel="{handler: \'iframe\', size: {x: 900, y: 500}}"></a>' +
													'</div>' +
												'</div>' +
												'<input type="hidden"  name="attribute[' + rh + '][property][' + h + '][mainImage]" id="propmainImage' + rh + or + '" value="">' +
												'<input type="hidden" class="text_area" size="12" name="imagetmp[' + rh + '][value][]"  />' +
												'<input type="file" size="20" name="attribute_' + rh + '_property_' + h + '_image"  >' +
											'</td>' +
											'<td class="td3">&nbsp;</td>' +
											'<td class="td4">' +
												'<img id="propertyImage' + rh + or + '" src="" style="display: none;" />' +
											'</td>' +
											'<td class="td5" align="right" style="padding-right: 25px;">' +
												'<span>Published:&nbsp;</span>' +
												'<input type="checkbox" class="text_area" size="55" name="attribute[' + rh + '][property][' + h + '][published]" checked="checked" value="1">' +
												'<span>&nbsp;Extra Field:&nbsp;</span>' +
												'<input type="input" class="text_area" size="8" name="attribute[' + rh + '][property][' + h + '][extra_field]" value="">' +
												'<div class="remove_attr">' +
													'<input value="Delete" onclick="javascript:deleteRow_property(\'attribute_table' + h + '\',\'' + tableRef + '\',\'sub_attribute_table' + rh + h + '\', \'' + rh + h + '\')" class="btn_attribute_remove" type="button" />' +
												'</div>' +
											'</td>' +
										'<tr>' +
									'</table>' +
...
function showBackgrounds(id) {
	var useBackgrounds = document.getElementById("useBackgrounds" + id);
	var designBackgrounds = document.getElementById("designBackgrounds" + id);

	if (useBackgrounds.checked)
	{
		designBackgrounds.style.display = "inline";
	}
	else
	{

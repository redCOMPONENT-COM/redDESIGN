...
class ReddesignControllerDesigntype extends RControllerForm
{
	...
	public function save($key = null, $urlVar = null)
	{
		...
		$originalId = $model->getState($this->context . '.id');
		...
		if (parent::save($key, $urlVar))
		{
			if ($task == 'save2copy')
			{
				...
				/** @var RedshopbTableProduct_Item $itemTable */
				...
				foreach ($combinations as $combination)
				{
					...
					/** @var RedshopbTableProduct_Item_Attribute_Value_Xref $itemAttributeValueTable */

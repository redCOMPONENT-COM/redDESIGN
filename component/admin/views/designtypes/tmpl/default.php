...
?>
<form action="index.php?option=com_reddesign&view=countries" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('rgrid.sort', 'COM_REDDESIGN_DESIGNTYPES_NAME', 'tbl.designtype_name', $listDirn, $listOrder);?>
					</th>
					<th>
